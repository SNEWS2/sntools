...
The p emission from the 16N* nucleus will sometimes leave the daughter nucleus 
...
x_sec_data = [(e_thr, None    , None    , 0.0     , None    , None    , None    , None    , None    , None    , None    , 0.0     ), #Estimated Threshold Energy
...
class Channel(BaseChannel):
    ...
    def dSigma_dE(self, eNu, eE):
        ...
        sigma = fit('proton')(eNu)*10**(-42)  # cross-section at eNu from the interp1d fit of Suzuki et al. 2018 data (units cm^2)
