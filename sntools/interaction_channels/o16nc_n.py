...
for j in range(1, 12):   
    # sorting through each partial cross-section removing any 'None' data points
...
data = {'gamma':gam, 'neutron':n, 'proton':p, 'deuteron':d, # Dictionary of data sets 
        'pp':pp, 'H3':H3, 'He3':He3, 'alpha':alp,       # for partial cross-sections
...
class Channel(BaseChannel):
    ...
    '''def gamma(self, eNu):
        ...
        If eNu > e_thr_g, then the O-15 nucleus is left in the excited state in 
        ~70% of interactions.
    ...
    def get_eE(self, eNu, cosT=0):
        ...
        else: eE = random.random()*(eNu-e_thr) + mN   # energy of emitted neutron generated randomly 
    ...
    def dSigma_dE(self, eNu, eE):
        ...
        sigma = fit('neutron')(eNu)*10**(-42)  # cross-section at eNu from the interp1d fit 
