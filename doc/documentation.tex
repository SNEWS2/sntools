...
\item Add an \texttt{elif} clause for your detector in the \texttt{\_\_init\_\_} function of the \texttt{Detector} class and set the height, radius and detector material there.
\end{itemize}
...
At the moment, all detector configurations are cylindrical. If your new detector configuration has a different shape, further changes will be necessary.
