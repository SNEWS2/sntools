...
\title{Documentation for sntools 0.5\footnote{See \url{https://github.com/JostMigenda/sntools} for the most recent version.}}
...
First, make sure you have Python\footnote{Either Python 2.7 or Python 3.x is fine.} installed on your computer.
