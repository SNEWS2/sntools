...
if args.wcsim:
    ...
    wcsimfile.write('# configuration options (based on the sample macro file in WCSim 1.8.0)\n')
    ...
    wcsimfile.write('/control/execute macros/daq.mac\n')
    wcsimfile.write('/DarkRate/SetDetectorElement tank\n')
    wcsimfile.write('/DarkRate/SetDarkMode 0\n')
    wcsimfile.write('/DarkRate/SetDarkHigh 1200\n')
    wcsimfile.write('/DarkRate/SetDarkLow -200\n')
