...
class NuEmissionTest(unittest.TestCase):
    ...
    def test_nu_emission(self):
        ...
        test_values = (
                       ( 3, 100, 8.822369704285614e+52),
                       (10, 100, 2.259719068605022e+53),
                       (50, 100, 3.972374875472509e+50),
                       ( 3, 110, 8.405614242135493e+52),
                       (10, 110, 2.235542709449266e+53),
                       (50, 110, 3.911081069511243e+50),
                      )
